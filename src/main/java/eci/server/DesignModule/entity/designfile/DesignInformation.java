...
public class DesignInformation {
 ...
 //   @SequenceGenerator(name="SEQUENCE2", sequenceName="SEQUENCE2", allocationSize=1)
    ...
    private final static String supportedExtension[] =
            //TODO : cat에서 분리되어 나오는 파일 확장자들로 등록
     ...
     * @param originName
     */
    public DesignInformation(String originName, String tag, String attach_comment) {
     ...
     * @param originName
     */
    public DesignInformation(String originName) {
        this.uniqueName = generateUniqueName(extractExtension(originName));
        this.originName = originName;
    }

    /**
     * design과 연관관계가 없다면 등록
     *
     * @param design
     */
    public void initDesign(Design design) {
        if (this.design == null) {
            this.design = design;
        }
    }
