...
//06-01 자가결재 여기서 에러
    ...
    public static List<RouteProduct> toCREntityList(
            RouteOrderingCreateRequest req,
            RouteOrdering routeOrdering,
            RoutePreset routePreset,
            MemberRepository memberRepository,
        ...
        List<String> routeProductName = List.of((routePreset.CRRouteName[0]));
        List<String> routeProductType = List.of((routePreset.CRRouteType[0]));
        List<String> routeProductTypeModule = List.of((routePreset.CRRouteTypeModule[0]));
        //만들어져야 하는 객체는 타입 길이에서 complete 뺀 만큼
        Integer neededRouteProductCnt = routeProductType.size()-1;
...
//06-01 자가결재 여기서 에러
        ...
        public static List<RouteProduct> toCOEntityList(
            RouteOrderingCreateRequest req,
            RouteOrdering routeOrdering,
            RoutePreset routePreset,
            MemberRepository memberRepository,
        ...
        List<String> routeProductName = List.of((routePreset.CORouteName[0]));
        List<String> routeProductType = List.of((routePreset.CORouteType[0]));
        List<String> routeProductTypeModule = List.of((routePreset.CORouteTypeModule[0]));
        //만들어져야 하는 객체는 타입 길이에서 complete 뺀 만큼
        Integer neededRouteProductCnt = routeProductType.size()-1;
...
//06-01 자가결재 여기서 에러
    ...
    public static List<RouteProduct> toRELEASEEntityList(
            RouteOrderingCreateRequest req,
            RouteOrdering routeOrdering,
            RoutePreset routePreset,
            MemberRepository memberRepository,
        ...
        List<String> routeProductName = List.of((routePreset.RELEASERouteName[0]));
        List<String> routeProductType = List.of((routePreset.RELEASERouteType[0]));
        List<String> routeProductTypeModule = List.of((routePreset.RELEASERouteTypeModule[0]));
        //만들어져야 하는 객체는 타입 길이에서 complete 뺀 만큼
        Integer neededRouteProductCnt = routeProductType.size()-1;
...
//06-01 자가결재 여기서 에러
    ...
    public static List<RouteProduct> toDocumentEntityList(
            RouteOrderingCreateRequest req,
            RouteOrdering routeOrdering,
            RoutePreset routePreset,
            MemberRepository memberRepository,
        ...
        List<String> routeProductName = List.of((routePreset.DOCRouteName[0]));
        List<String> routeProductType = List.of((routePreset.DOCRouteType[0]));
        List<String> routeProductTypeModule = List.of((routePreset.DOCRouteTypeModule[0]));
        //만들어져야 하는 객체는 타입 길이에서 complete 뺀 만큼
        Integer neededRouteProductCnt = routeProductType.size()-1;
