...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.PUT, "/project/{revisedId}/{newMadeItemId}").authenticated()
                .antMatchers(HttpMethod.PUT, "/project/temp/end/{revisedId}/{newMadeItemId}").authenticated()
