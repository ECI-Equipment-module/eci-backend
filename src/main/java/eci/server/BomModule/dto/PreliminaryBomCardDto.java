...
//@NoArgsConstructor
//@AllArgsConstructor
//public class PreliminaryBomCardDto {
//
//    private Long id;
...
//    private List<PreliminaryBomCardDto> children;
//
//
//    public static List<PreliminaryBomCardDto> toDtoList(List<PreliminaryBomCard> preliminaryBomCards) {
//        //계층형 구조로 손쉽게 변환
//        NestedConvertHelper helper = NestedConvertHelper.newInstance(
//
//                preliminaryBomCards, //계층형 구조로 변환할 엔티티 목록
//                c -> new PreliminaryBomCardDto(
