...
//////////////////////////////////////////////////////////////////////////
        List<CoCoEffect> coCoEffects = coCoEffectRepository.findByChangeOrder(this);

        coCoEffectRepository.deleteAll(coCoEffects);
        ...
        for(CoCoEffect coCoEffect: coCoEffectsList){
            coCoEffectRepository.save(coCoEffect);
        }
