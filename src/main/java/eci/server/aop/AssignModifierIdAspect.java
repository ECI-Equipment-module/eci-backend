...
public class AssignModifierIdAspect {
    ...
    @Before("@annotation(eci.server.aop.AssignModifierId)")
    ...
    public void assignModifierId(JoinPoint joinPoint) {
        //메소드 호출 전 메소드 수행
        ...
        Arrays.stream(joinPoint.getArgs())
                ...
                .forEach(arg -> getMethod(arg.getClass(), "setModifierId")
                        .ifPresent(setModifierId ->
                                invokeMethod
                                        (arg, setModifierId, authHelper.extractMemberId())));
    }
