...
@Transactional(readOnly = true)
    public class CustomMakerRepositoryImpl extends QuerydslRepositorySupport implements CustomMakerRepository {
        ...
        public CustomMakerRepositoryImpl(JPAQueryFactory jpaQueryFactory) { // 4
            super(Maker.class);
            this.jpaQueryFactory = jpaQueryFactory;
        }

        @Override
        public Page<CustomMakerResponse> findAllByCondition(MakerReadCondition cond) {
        ...
        private List<CustomMakerResponse> fetchAll(Predicate predicate, Pageable pageable) { // 6
